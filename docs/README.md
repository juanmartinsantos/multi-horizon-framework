...
<div class="highlight-box">
  <img src="icon-research.svg" width="120" alt="Research icon">
  <p>A multi-horizon ensemble-based framework for dynamic variable importance analysis in air temperature forecasting.</p>
</div>
...
<ul class="download-list">
  ...
  <li>
    <span>Importance by variable subtype (temperature, year, day interval, ...)</span>
