...
<td>Martín, J., &amp; Sáez, J. A. (2026). A knowledge-extraction framework for multi-horizon variable importance analysis in air temperature forecasting <em>[Manuscript submitted to Stochastic Environmental Research and Risk Assessment]</em>.</td>
</tr></table>
</div>
